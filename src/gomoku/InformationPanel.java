...
public class InformationPanel extends JPanel {
	...
	/*
	 * public void goWait(){ removeAll(); this.add(new
	 * JLabel("Computer thinking, be patient.")); //not working, cannot call
	 * repaint() too fast! updateUI(); //this.paint(this.getGraphics()); }
	 * public void reWait(){ removeAll(); this.add(panelNO0);
	 * this.add(panelNO1); this.add(panelNO2); }
	 */
}
